<?php $this->setSiteTitle('Accepted_Maintanance.') ?>
...
<div class="table-wrapper">
    ...
    <div class="area" >
        <table id="selectedColumn" class="center table table-body table-striped table-hover table-bordered table-sm mb-0">
            <thead>
